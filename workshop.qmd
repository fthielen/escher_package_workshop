...
Welcome! In this session we will get our hands dirty with some coding in R. The aim of this session is to empower you with skills to that make you able to build a (basic) R package. In order to achieve that, this tutorial is a step-by-step guide. The material is inspired by the tutorial published by Brad Duthie (see [here](https://ourcodingclub.github.io/tutorials/writing-r-package/#github)) which is part of the Coding Club. We like to thank Brad and the Coding Club for providing his work open source for reuse.
...
![](images/new_project_select_new_repo.png)
...
The following box shows up.

![](images/new_folder_box.png)
